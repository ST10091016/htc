    ...
    const cardsData = [
        {
            ...
            description:
                'Founder of The Harvest Tabernacle Church.',
            imageUrl: Apostle,
        },
        {
        ...
        },
        {
            ...
            description:
                'Part of The Harvest Tabernacle Church.',
            imageUrl: Evan1,
        }, {
            ...
            description:
                'From The Matsulu Worship Center.',
            imageUrl: Evan3,
        }, {
            title: 'Pastor AP Khoza',
            description:
                'From The Magudu Worship Center.',
            imageUrl: Pastor,
        },
    ];
    ...
    return (
        <div className="mx-4 my-6">
            <div className="w-full p-4 bg-[url('https://images.pexels.com/photos/946186/pexels-photo-946186.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')]  bg-cover bg-center bg-gray-400 bg-blend-multiply text-center h-60  border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <h1 className="p-16 text-5xl font-bold text-white dark:text-white">Church Ministers</h1>
            </div>
            <br/>
