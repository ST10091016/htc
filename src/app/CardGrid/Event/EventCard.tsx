                ...
                return (
                    ...
                    >
                        <div className="flex flex-col space-y-1.5 p-4">
                            <h3 className="tracking-tight text-2xl font-bold text-gray-900 dark:text-gray-100">{event.name}</h3>
                        </div>
                        <div className="p-6 space-y-4">
                            <div className="flex items-center space-x-2">
                                ...
                                <span className="text-gray-700 dark:text-gray-300">{event.date.toString()}</span>
                            </div>
                            <div className="flex items-center space-x-2">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div className="flex items-start space-x-2">
                                ...
                                <p className=" text-gray-700 w-auto dark:text-gray-300">{event.description}</p>
                            </div>
