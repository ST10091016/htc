...
export default async function CenterMemberCard() {
  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-1 md:gap-6 xl:grid-cols-1 2xl:gap-8 w-12/12 m-auto">
        {centers.map((center: any) => {
          return (
            <div
              key={center.id}
              className="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 w-auto"
            >
              <div className="px-4 p-4">
                <div className="flex flex-col lg:flex-row items-center h-32 lg:h-auto">
                  ...
                  <div className="flex-1 ms-4 w-auto" >
                    <p className="gap-1 items-center text-sm font-medium text-gray-900 truncate dark:text-white">
                      {center.name}
                    </p>
