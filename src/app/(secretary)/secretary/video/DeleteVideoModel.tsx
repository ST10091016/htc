...
import { DeleteVideo } from "@/app/(secretary)/secretary/(users)/_actions/videos";
import DeleteButton from "@/app/(secretary)/secretary/(users)/_components/DeleteButton";

export default function DeleteVideoModel({ videoId }: { videoId: string }) {
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div className="bg-white rounded-lg p-6 w-180 dark:bg-gray-800">
              ...
              <div className="flex justify-center">
                <form
                  action={async () => {
                    const result = await DeleteVideo(videoId).then((result) => {
                      if (result === null) {
