...
import DeleteNewsModel from "./DeleteNewsModel";
        ...
        return (
          <div key={newItem.id} className="m-3">
            <div className="w-full p-4 bg-white  border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
              ...
              <p className="mb-5 text-base text-gray-500 sm:text-md dark:text-gray-400">
                {newItem.content}
              </p>
              <div className="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
                <UpdateNews newsDetails={newItem} newsId={newItem.id} />
               <DeleteNewsModel newsId={newItem.id} />
              </div>
            </div>
          </div>
        );
